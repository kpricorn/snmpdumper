...
# <JSSNMPDEVICE category="Cisco Switches" model="Catalyst 2950-24">
#   <JSSNMPVAR>
#     <JSOID value="1.3.6.1.2.1.2.2.1.15.23" syntax="COUNTER"/> 
#     <JSVALUESET>
#       <JSVALUE value="0"/>
#     </JSVALUESET>
#   </JSSNMPVAR>
...
# <JSSNMPVAR>
#   <JSOID value="1.3.6.1.2.1.1.3.0" syntax="TIMETICKS"/> 
#   <JSVALUERANGE low="1000000" high="900000000" type="2" count="100" variation="200000" />
# </JSSNMPVAR>

# <JSSNMPVAR>
#   <JSOID value="1.3.6.1.2.1.2.2.1.7.7" syntax="INTEGER"/>
#   <JSVALUESET probabilistic="1">
#     <JSVALUE weight="80" value="1"/>
#     <JSVALUE weight="15" value="2"/>
#     <JSVALUE weight="5" value="3"/>
#   </JSVALUESET>	
# </JSSNMPVAR>
...
manager = Manager.new(snmpconfig)
